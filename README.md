...
-P *XPATH*
:   Response path, that is used to narrow down the subset of printed
    ...
    `<interface>` elements. *PATH* defaults to `"/"`. The maximum size of
...
If NDM is unavailable, or returns an invalid response, or any generic
